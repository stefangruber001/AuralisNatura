...
- **💶 Pricing (overrides §8 ladder).** Website prices were cut so nothing exceeds
  €700: **Root €220 · Reset €490 (2×€260) · Transformation €690 (3×€240) ·
  Companion €120/mo.** ⚠️ **OPEN TASK:** Document 02 financials + §8 below still
  show the OLD prices (Reset €690, Transformation €1,290) and must be reworked to
  match (unit economics €/hour, Year-1 projections). Until done, treat §8 numbers
  as stale.
