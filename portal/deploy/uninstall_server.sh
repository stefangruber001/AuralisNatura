...
readonly UNITS="auralis-portal.service auralis-update.timer auralis-update.service auralis-backup.timer auralis-backup.service auralis-social-scan.timer auralis-social-scan.service auralis-social-publish.timer auralis-social-publish.service cloudflared-auralis.service"
